...
<section>
	<div class="slideshow">
		<div class="sidebar">
			<h2 on:mouseover={() => setView(0)} class:active={currView == 0}>Dream</h2>
			<h2 on:mouseover={() => setView(1)} class:active={currView == 1}>Cultivate</h2>
			<h2 on:mouseover={() => setView(2)} class:active={currView == 2}>Belong</h2>
		</div>
		{#key currView}
			<div class="slide-wrapper" in:fade={{ duration: 300 }}>
				<div class="slide">
